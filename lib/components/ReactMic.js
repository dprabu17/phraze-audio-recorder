...
var _AudioRecorder = require('../libs/AudioRecorder');
...
var ReactMic = function (_Component) {
  ...
  ReactMic.prototype.componentDidMount = function componentDidMount() {
    ...
    if (audioElem) {
      ...
      this.setState({
        microphoneRecorder: new _MicrophoneRecorder.MicrophoneRecorder(onStart, onStop, onSave, onData, onBlock, onPause, options),
        canvas: canvas,
        canvasCtx: canvasCtx
      }, function () {
        _this2.visualize();
